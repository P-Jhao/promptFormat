...
export const NODE_TO_STEP_MAP: Record<string, StepType> = {
  ...
  typeNode: "types",
  utilsNode: "utils",
  mockDataNode: "mockData",
  serviceNode: "service",
  hooksNode: "hooks",
  componentSubgraph: "componentsCode",
  pageSubgraph: "pagesCode",
  layoutNode: "layouts",
  styleGenNode: "styles",
  appGenNode: "app",
  assembleNode: "files",
  postProcessNode: "files",

  // Figma 流程节点
  figmaInputNode: "figmaRawCode",
  imageDownloadNode: "figmaImageProcessed",
  astParserNode: "figmaAstParsed",
  blockExtractNode: "figmaBlockExtract",
  geometryGroupNode: "figmaGeometryGroup",
  sectionNamingNode: "figmaSectionNaming",
  componentGenNode: "figmaComponentGen",
  assemblyNode: "figmaAssembly",
  figmaPostProcessNode: "figmaAssembly",
};
